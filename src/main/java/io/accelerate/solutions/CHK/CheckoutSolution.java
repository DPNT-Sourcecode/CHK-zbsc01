...
public class CheckoutSolution {
    public Integer checkout(String skus) {
        ...
        priceMap.put('J', 60); priceMap.put('K', 80); priceMap.put('L', 90);
        priceMap.put('M', 15); priceMap.put('N', 40); priceMap.put('O', 10);
        priceMap.put('P', 50); priceMap.put('Q', 30); priceMap.put('R', 50);
        priceMap.put('S', 30); priceMap.put('T', 20); priceMap.put('U', 40);
        priceMap.put('V', 50); priceMap.put('W', 20); priceMap.put('X', 90);
        priceMap.put('Y', 10); priceMap.put('Z', 50);
